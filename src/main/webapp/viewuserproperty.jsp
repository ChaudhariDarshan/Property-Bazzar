...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper">
        <div class="col-md-12 graphs" style="background-image: url('tree.jpg'); background-size: cover;">
	   <div class="xs">
  	
 
	<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
				<div class="panel-heading">
					<h2>My Property Information Table</h2>
        ...
        try
        {
        	PreparedStatement ps1=con.prepareStatement("Select * from property_tbl where uemail=? and pstatus=? ");
        	ps1.setString(1, Users.getEmail());
        	ps1.setString(2, "Available");
                ...
                <tr>
                    ...
                    <center><th><%=rs.getString("pstatus")%></th></center>
                 	<center><th><a href="deleteproperty.jsp?pid=<%=rs.getString("pid")%>">Delete</a></th>
                 	 <center><th><a href="sold.jsp?pid=<%=rs.getString("pid")%>"> Marked As Sold</a></th>
                    <center><th><a href="checkenquiry.jsp?pid=<%=rs.getString("pid")%>"> Check Equiry</a></th>
  	...
  	<div class="copy_layout login">
					<p>Copyright &copy; 2023 Harshada Properties,Dhule. All Rights Reserved | Design by Darshan Chaudhari </p>
				 </div>
   </div>
      </div>
      <!-- /#page-wrapper -->
