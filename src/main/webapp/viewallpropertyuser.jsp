...
<div id="wrapper">
	...
	<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
        ...
        try
        {
        	PreparedStatement ps1=con.prepareStatement("Select * from property_tbl where pstatus=? and uemail!=?");
        	...
        	%>
                ...
                <tr>
                    ...
                    <center><th><a href="enquiryproperty.jsp?pid=<%=rs.getString("pid")%>">Equiry</a></th>
                </tr>
               </div></center>
