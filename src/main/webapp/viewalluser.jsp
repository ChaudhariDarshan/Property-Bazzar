...
<div id="wrapper">
	...
	<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
				<div class="panel-heading">
					<h2>All User Information Table</h2>
        ...
        try
        {
        	...
        	%>
      			<center><div>
                <tr>
                    <center><th><%=rs.getString("uid")%> </th></center>
                    <center><th><%=rs.getString("uname")%></th></center>
                    <center><th><%=rs.getString("uemail")%></th></center>
                    <center><th><%=rs.getString("upass")%></th></center>
                    <center><th><%=rs.getString("umob")%></th></center>
                    <center><th><%=rs.getString("uadd")%></th></center>
                    <center><th><a href="delete.jsp?uid=<%=rs.getInt("uid")%>">Delete</a></th>
                </tr>
               </div></center>
